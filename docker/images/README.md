...
-	[`latest` (*master/docker/images/Dockerfile*)](https://github.com/ness-network/skycoin-explorer/blob/master/docker/images/Dockerfile)
-	[`develop` (*develop/docker/images/Dockerfile*)](https://github.com/ness-network/skycoin-explorer/blob/develop/docker/images/Dockerfile)

# Quick reference

-	**Where to file issues**:
	[https://github.com/ness-network/skycoin-explorer/issues](https://github.com/ness-network/skycoin-explorer/issues)
-	**Maintained by**:
	[The Skycoin community](https://github.com/ness-network/skycoin-explorer)
-	**Supported architectures**: ([more info](https://github.com/docker-library/official-images#architectures-other-than-amd64))
	[`amd64`](https://hub.docker.com/r/ness-network/skycoin-explorer), [`arm32v6`](https://hub.docker.com/r/ness-network/skycoin-explorer), [`arm64v8`](https://hub.docker.com/r/ness-network/skycoin-explorer)
-	**Image updates**:
...
[Skycoin explorer](https://explorer.privateness.network) is a tool to interact with Skycoin's ecosystem.
...
$ docker build -t ness-network/skycoin-explorer:[tag] -f docker/images/Dockerfile .
```

Or use the official image

```sh
$ docker pull ness-network/skycoin-explorer:[tag]
```

Now launch the container

```sh
$ docker run -d --name explorer-node -p 8001:8001 ness-network/skycoin-explorer:[tag]
```
...
```sh
$ docker run -d --name explorer-node -p 8001:8001 -e SKYCOIN_ADDR="http://192.168.1.1:6420" ness-network/skycoin-explorer:[tag]
```
